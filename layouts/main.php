    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top scrolling-navbar">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <a class="nav-item nav-link" href="index.php?view=notes">Notizen</a>
                <a class="nav-item nav-link" href="index.php?view=contacts">Kontaktbuch</a>
            </div>
        </div>
    </nav>
</header>
    ...
    <div class="col-md-12 bg-dark text-light">
        <div class="col-md-9 mx-auto ">
            <ul class="list-group list-group-horizontal-md">
                <li class="list-group-item bg-dark">qqq</li>
                <li class="list-group-item bg-dark">qqq</li>
                <li class="list-group-item bg-dark">qqq</li>
            </ul>
        </div>
